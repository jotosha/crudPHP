...
do {
    if ($res = $conn->store_result()) {
        ...
        while($row = $res->fetch_assoc()) {
            ...
            $xml_zzasilacz = $doc->createElement("Zasilacz");
            ...
            $xml_zasilacz = $doc->createTextNode($row["zasilacz"]);
            ...
            $id->appendChild( $xml_zzasilacz );
            $xml_zzasilacz->appendChild( $xml_zasilacz );
